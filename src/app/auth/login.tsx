...
import { View, Text, StyleSheet, TextInput, KeyboardAvoidingView, Platform, TouchableOpacity, ActivityIndicator, Linking } from 'react-native';
      ...
      >
        <View style={styles.content}>
          ...
          <Text style={styles.subtitle}>
            {mode === 'login' ? 'Login with your email to enter AI Adda' : 'Sign up free with email and password'}
          </Text>
          ...
          {pendingVerification && (
            <Text style={styles.spamHint}>
              Didn&apos;t get it? Check Spam/Promotions and search for "Supabase" or "AI Adda".
            </Text>
          )}
